    ...
    <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
                ...
                <div class="bg-white border rounded shadow p-2">
                    <div class="flex flex-row items-center">
                        ...
                        <div class="flex-1 text-right md:text-center">
                            <h5 class="font-bold uppercase text-gray-500">Total Permintaan hari ini</h5>
                            <h3 class="font-bold text-3xl">12</h3>
                        </div>
                    </div>
                </div>
                <!--/Metric Card-->
            ...
            <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                ...
                <div class="bg-white border rounded shadow p-2">
                    <div class="flex flex-row items-center">
                        ...
                        <div class="flex-1 text-right md:text-center">
                            <h5 class="font-bold uppercase text-gray-500">Check-in</h5>
                            <h3 class="font-bold text-3xl">3 Orang</h3>
                        </div>
                    </div>
                </div>
                <!--/Metric Card-->
            ...
            <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                ...
                <div class="bg-white border rounded shadow p-2">
                    <div class="flex flex-row items-center">
                        ...
                        <div class="flex-1 text-right md:text-center">
                            <h5 class="font-bold uppercase text-gray-500">Check-out</h5>
                            <h3 class="font-bold text-3xl">2 Orang</h3>
                        </div>
                    </div>
                </div>
                <!--/Metric Card-->
        ...
        <div class="flex flex-row flex-wrap flex-grow mt-2">
            <div class="w-full md:w-1/2 p-3">
                ...
                <div class="bg-white border rounded shadow">
                    <div class="border-b p-3">
                        <h5 class="font-bold uppercase text-gray-600">Tabel Permintaan hari ini</h5>
                    </div>
                    <div class="p-5">
                    </div>
                </div>
            ...
            <div class="w-full md:w-1/2 p-3">
                ...
                <div class="bg-white border rounded shadow">
                    <div class="border-b p-3">
                        <h5 class="font-bold uppercase text-gray-600">Tabel Tamu hari ini</h5>
                    </div>
                    <div class="p-5">
