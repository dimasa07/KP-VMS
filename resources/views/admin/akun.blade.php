                    ...
                    <form method="POST" @submit.prevent="submit()" x-data="formData()">
                        <div class="relative pb-11 px-6">
                            ...
                            <div class="inline-flex absolute right-0 bottom-0">
                                ...
                                <button type="button" x-show="!showFormEdit" @click="showFormEdit= !showFormEdit; akun={{$akun}}" class=" bg-blue-600 hover:bg-blue-800 text-white py-1 px-2 rounded mx-2">Edit Akun</button>
                                <button type="submit" @click="formData.id=akun.id;" x-show="showFormEdit" class=" bg-green-600 hover:bg-green-800 text-white py-1 px-2 rounded mx-2">Simpan Perubahan</button>
