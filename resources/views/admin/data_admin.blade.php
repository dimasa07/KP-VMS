        ...
        <div class="w-full p-3">
            ...
            <div class="bg-white border rounded shadow">
                <div class="border-b px-3 py-6">
                    <h5 class="text-3xl font-bold uppercase text-gray-600">Data Admin</h5>
                </div>
            </div>
        </div>
        <div class="w-full p-3">
                    ...
                    <table x-show="!showDetail" class="w-full p-5 text-gray-700 border-3 border-black">
                        <thead>
                            <tr>
                                ...
                                <th class="border-2 text-blue-900 p-2">Nama Admin</th>
                        ...
                        <tbody>
                            @for($i = 0 ; $i < count($admin); $i++) <tr>
                                ...
                                <div>
                                        <button @click="admin={{ $admin[$i] }}; showDetail= !showDetail" class="bg-blue-600 hover:bg-blue-800 text-white py-1 px-2 rounded">Detail</button>
                                    </div>
                                </td>
                                </tr>
                                @endfor
