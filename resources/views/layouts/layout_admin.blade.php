                ...
                <div class="flex relative inline-block float-right">
                    ...
                    <div class="relative text-sm">
                        <button id="userButton" class="flex items-center focus:outline-none mr-3">
                            <span class="fas fa-user w-8 h-8 rounded-full mr-4" alt="Avatar of User"></span> <span class="hidden md:inline-block">Hi, Admin </span>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-3 lg:mt-1 bg-white z-20" id="nav-content">
                <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                    <li class="mr-6 my-2 md:my-0">
                        <a href="{{ route('admin.index') }}" class="block py-1 md:py-3 pl-1 align-middle {{ request()->is('admin') ? 'text-blue-600 border-blue-600 hover:border-blue-600 hover:text-blue-600 ' : 'text-gray-500 border-white hover:border-blue-600 hover:text-blue-600' }} no-underline border-b-2 ">
                            <i class="fas fa-home fa-fw mr-3 {{ request()->is('admin') ? 'text-blue-600':'' }}"></i><span class="pb-1 md:pb-0 text-sm">Dasbor</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                    ...
                    <li class="mr-6 my-2 md:my-0">
                        <a href="{{ route('admin.buku-tamu.all') }}" class="block py-1 md:py-3 pl-1 align-middle {{ request()->is('admin/buku-tamu/all') ? 'text-blue-600 border-blue-600 hover:border-blue-600 hover:text-blue-600 ' : 'text-gray-500 border-white hover:border-blue-600 hover:text-blue-600' }} no-underline border-b-2 ">
                            <i class="fas fa-book fa-fw mr-3 {{ request()->is('admin/buku-tamu/all') ? 'text-blue-600':'' }}"></i><span class="pb-1 md:pb-0 text-sm">Laporan</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
